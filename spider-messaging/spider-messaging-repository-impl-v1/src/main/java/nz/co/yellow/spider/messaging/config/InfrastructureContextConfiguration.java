...
@ComponentScan(basePackages = { "nz.co.yellow.spider.messaging.ds",
		"nz.co.yellow.spider.messaging.data" })
@EnableJpaRepositories("nz.co.yellow.spider.messaging.data.repository")
